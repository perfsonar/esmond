...
class Client(Iface):
  ...
  def send_select(self, path, begin_time, end_time, flags, cf, resolution):
  ...
  def send_get_interfaces(self, device, all_interfaces):
...
class Processor(Iface, TProcessor):
  ...
  def process_select(self, seqid, iprot, oprot):
    ...
    result = select_result()
    try:
      result.success = self._handler.select(args.path, args.begin_time, args.end_time, args.flags, args.cf, args.resolution)
  ...
  def process_get_interfaces(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = get_interfaces_result()
    result.success = self._handler.get_interfaces(args.device, args.all_interfaces)
...
class select_args(object):
  ...
  thrift_spec = (
    ...
    (2, TType.STRING, 'begin_time', None, None, ), # 2
    (3, TType.STRING, 'end_time', None, None, ), # 3
    (4, TType.STRING, 'flags', None, None, ), # 4
    (5, TType.STRING, 'cf', None, None, ), # 5
    (6, TType.STRING, 'resolution', None, None, ), # 6
  )
  ...
  def write(self, oprot):
    ...
    if self.end_time != None:
      ...
      oprot.writeFieldEnd()
    if self.flags != None:
      oprot.writeFieldBegin('flags', TType.STRING, 4)
      oprot.writeString(self.flags)
      oprot.writeFieldEnd()
    if self.cf != None:
      oprot.writeFieldBegin('cf', TType.STRING, 5)
...
class get_interfaces_args(object):

  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'device', None, None, ), # 1
    (2, TType.BOOL, 'all_interfaces', None, None, ), # 2
  )
  ...
  def __init__(self, d=None):
    ...
    if isinstance(d, dict):
      if 'device' in d:
        self.device = d['device']
      if 'all_interfaces' in d:
        self.all_interfaces = d['all_interfaces']
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.BOOL:
          self.all_interfaces = iprot.readBool();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.device != None:
      ...
      oprot.writeFieldEnd()
    if self.all_interfaces != None:
      oprot.writeFieldBegin('all_interfaces', TType.BOOL, 2)
      oprot.writeBool(self.all_interfaces)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class get_interfaces_result(object):
