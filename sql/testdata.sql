...
INSERT INTO OID (id,name,oidtypeid) VALUES (7, 'ifName', 3);
INSERT INTO OID (id,name,oidtypeid) VALUES (8, 'ifAlias', 3);
INSERT INTO OID (id,name,oidtypeid) VALUES (9, 'ifSpeed', 4);
INSERT INTO OID (id,name,oidtypeid) VALUES (10, 'ifHighSpeed', 4);
INSERT INTO OID (id,name,oidtypeid) VALUES (11, 'ipAdEntIfIndex', 6);
...
INSERT INTO OIDSet (id,name,frequency, pollerid, poller_args)
       VALUES (1, 'FastPoll', 30, 1,
        'chunk_mapper=tsdb.YYYYMMDDChunkMapper correlator=IfNameCorrelator');
INSERT INTO OIDSet (id,name,frequency, pollerid, poller_args)
